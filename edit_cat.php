...
// если запрос POST 
if(isset($_POST['namecat']) && isset($_POST['id'])){
 
    $id = htmlspecialchars(mysqli_real_escape_string($link, $_POST['id']));
    $namecat = htmlspecialchars(mysqli_real_escape_string($link, $_POST['namecat']));


    $query ="UPDATE category SET namecat='$namecat' WHERE id='$id'";
...
{   
    ...
    if($result && mysqli_num_rows($result)>0) 
    {
        ...
        echo "<h2>Редактирование</h2>
            ...
            <p>Имя:<br> 
            <input class='form-control' type='text' name='namecat' value='$namecat' /></p>
